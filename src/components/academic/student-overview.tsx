...
export function StudentOverview({
  ...
  return (
    <section className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
      <article className="rounded-lg border border-black/10 bg-black/5 p-4 shadow-2xl shadow-black/20">
        ...
        <div className="mt-5 rounded-md border border-white/10 bg-white/[0.03] p-4">
          <div className="flex items-start gap-3">
            <span className="rounded-md border border-sky-400/20 bg-sky-800 p-2 text-sky-200">
